      ...
      <div class="row" style="margin-top: 10px">
        <div class="col-md-12">
          <ul class="breadcrumb"">
            ...
            <li><a href="">Đề thi ngẫu nhiên</a></li>
          </ul>
        </div>
      </div>
      <form action="chamdiem.php" method="get">
        <input type="hidden" name="tieude" value="Đề thi ngẫu nhiên">
        <input type="hidden" name="dethi" value="Đề thi">
        <div class="panel panel-primary">
         <div class="panel-heading">
          <h3 class="text-center"><strong>Đề thi ngẫu nhiên</strong></h3>
        </div>
